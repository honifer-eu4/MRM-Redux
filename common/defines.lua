...
NDiplomacy = {
	...
	HRE_FOREIGN_CONTROL_PENALTY = 0,			-- Each foreign-controlled province in the empire (owned or vassalised) lowers IA by this amount
...
NCountry = {
	...
	CIRCUMNAVIGATION_PROVINCE_2 = 2259,			-- Provinces for circumnavigation (magellan strait)
	...
	INNOVATIVENESS_FIRST_REACHED_TECH_LEVEL = 1.0,  -- Innovativeness bonus to first country (or countries) to reach a certain tech level.
...
NMilitary = {
	...
	BANNER_AGE_MULTIPLIER = 0,
	BANNER_STARTING_STRENGTH = 0.001,					-- Starting strength of a banner regiment, 1.0 being full strength
	...
	BATTLE_DAILY_MORALE_DAMAGE = 0,				-- Deployed troops take this fraction of their maximum morale as damage
	...
	MERCENARY_COMPANY_ARMY_TRADITION = 25.0,		-- At what army tradition mercenaries leaders are generated on.
...
NGovernment = {
	...
	GOVERNMENT_REFORM_COST_CENTRALIZE_STATE = 10.0,
